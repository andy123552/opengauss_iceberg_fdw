...
FDW_SRC_DIR="${FDW_SRC_DIR:-${ROOT_DIR}}"
BRIDGE_SRC_DIR="${BRIDGE_SRC_DIR:-$(cd "${ROOT_DIR}/.." && pwd)/iceberg-rust-bridge}"
CATALOG_SRC_DIR="${CATALOG_SRC_DIR:-$(cd "${ROOT_DIR}/.." && pwd)/Catalog}"
OG_INCLUDE_SRC_DIR="${OG_INCLUDE_SRC_DIR:-$(cd "${ROOT_DIR}/.." && pwd)/openGauss-server/src/include}"
